    ...
    <nav class="navbar fixed-top navbar-expand-sm navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle melhora_brilho" href="#" id="dropdown10" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">＋ Cadastrar</a>
                <div class="dropdown-menu troca_cor" aria-labelledby="dropdown10">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle melhora_brilho" href="#" id="dropdown10" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">≡ Listar</a>
                <div class="dropdown-menu troca_cor" aria-labelledby="dropdown10">
